...
| M14-18 | （值得）Lua / MicroPython / QuickJS 轻量脚本运行时 | **P3** | M11-13 | 6 | 脚本容器内运行 hello 级验证 |
...
| 配置 | 关键路径 | 说明 |
|---|---|---|
| 1 人 | 约 13–16 个月 | 串行全部任务 + 20% 缓冲 |
| 2 人（主线 + M12 并行） | 约 9–11 个月 | 关键路径 250 − M12(27) ≈ 223 人日 ÷ 2 + M12 并行消化 + 20% 缓冲 |
